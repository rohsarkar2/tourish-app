...
import { PorterProductListScreenProps } from "../../navigation/NavigationTypes";
...
export default class PorterProductList extends React.Component<
	PorterProductListScreenProps,
	States
> {
	static contextType = AppContext;
	declare context: React.ContextType<typeof AppContext>;

	constructor(props: PorterProductListScreenProps) {
		super(props);
		this.state = {
			products: [],
			currencies: [],
	...
	loadProducts = () => {
		...
		ProductService.getPorterProducts(reqData)
			.then((response: any) => {
	...
	gotoProductDetails = (item: any) => {
		this.props.navigation.navigate("Porter", {
			productId: item._id,
