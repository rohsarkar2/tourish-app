...
import { LoungeProductListScreenProps } from "../../navigation/NavigationTypes";
...
export default class LoungeProductList extends React.Component<
	LoungeProductListScreenProps,
	States
> {
	static contextType = AppContext;
	declare context: React.ContextType<typeof AppContext>;

	constructor(props: LoungeProductListScreenProps) {
		super(props);
	...
	loadProducts = () => {
		...
		ProductService.getLoungeProducts(reqData)
			.then((response: any) => {
	...
	gotoProductDetails = (item: any) => {
		this.props.navigation.navigate("Lounge", {
			productId: item._id,
