...
import { MobilityAssistProductListScreenProps } from "../../navigation/NavigationTypes";
...
export default class MobilityAssistProductList extends React.Component<
	MobilityAssistProductListScreenProps,
	States
> {
	static contextType = AppContext;
	declare context: React.ContextType<typeof AppContext>;

	constructor(props: MobilityAssistProductListScreenProps) {
		super(props);
		this.state = {
			products: [],
			currencies: [],
	...
	loadProducts = () => {
		...
		ProductService.getMobilityAssistProducts(reqData)
			.then((response: any) => {
	...
	gotoProductDetails = (item: any) => {
		this.props.navigation.navigate("MobilityAssist", {
			productId: item._id,
