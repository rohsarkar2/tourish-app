...
import { MobilityAssistScreenProps } from "../../navigation/NavigationTypes";
...
const MobilityAssist: React.FC<MobilityAssistScreenProps> = (
	props: MobilityAssistScreenProps
): React.ReactElement => {
