...
import { LoungeScreenProps } from "../../navigation/NavigationTypes";
...
const Lounge: React.FC<LoungeScreenProps> = (
	props: LoungeScreenProps
): React.ReactElement => {
					...
					<ScrollView showsVerticalScrollIndicator={false}>
						<View style={styles.container}>
							...
							<View style={{ width: "100%", paddingHorizontal: 15 }}>
								...
								>
									{productDetails.amenities.map((item: any, index: number) => (
										<View
										...
										>
											...
											>
												<Text style={styles.amenitiesTxt}>{item.name}</Text>
											</View>
										</View>
									))}
								</View>
